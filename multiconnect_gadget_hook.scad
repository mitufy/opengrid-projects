...
hook_type = "Centered"; //["Straight", "Centered", "Loop"]

/* [Hook Options] */
//the width for complete symmetry is 13.2.
body_width = 8; //0.4
...
hook_tip_angle = 180; //[10:5:260]

/* [Advanced Options] */
//This changes which direction the gadget faces when it is completely screwed in to a snap.
