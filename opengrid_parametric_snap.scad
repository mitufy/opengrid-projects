...
module snap() {
  fold_for_printing(body_thickness=snap_thickness + ochead_total_height, fold_pos_offset=ochead_middle_to_bottom + eps, condition=generate_snap == "openConnect (Folded)")
