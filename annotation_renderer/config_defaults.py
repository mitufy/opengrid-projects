...
ANNOTATION_LABEL_FONT_SIZE_PX = 58
ANNOTATION_TITLE_FONT_SIZE_PX = 68
ANNOTATION_AUX_LABEL_FONT_SIZE_PX = 60
ANNOTATION_FONT = "sans"
ANNOTATION_COLOR_BLACK = "#000000"
ANNOTATION_COLOR_BLUE = "#4169E1"
ANNOTATION_COLOR_RED = "#FF0000"
ANNOTATION_COLOR_WHITE = "#ffffff"
DEFAULT_TYPE_STYLES: dict[str, dict[str, object]] = {
    "grids": {
        "line_colors": [ANNOTATION_COLOR_BLUE],
        "font": ANNOTATION_FONT,
        "text_shade": 1.0,
    },
    "mm": {
        "line_colors": [ANNOTATION_COLOR_BLACK],
        "font": ANNOTATION_FONT,
        "text_shade": 1.0,
    },
    "radius": {
        "line_colors": [ANNOTATION_COLOR_RED],
        "font": ANNOTATION_FONT,
        "text_shade": 1.0,
    },
    "angle": {
...
CAMERA_VIEW_PRESETS = {
    "front_left": {"camera_view": "front", "camera_orbit_deg": [-35, 0], "camera_distance_scale": 1},
    "front_right": {"camera_view": "front", "camera_orbit_deg": [35, 0], "camera_distance_scale": 1},
    "back_left": {"camera_view": "back", "camera_orbit_deg": [35, 0], "camera_distance_scale": 1},
    "back_right": {"camera_view": "back", "camera_orbit_deg": [-35, 0], "camera_distance_scale": 1},
    "top_front": {"camera_view": "front", "camera_orbit_deg": [0, 67], "camera_distance_scale": 1},
    "top_back": {"camera_view": "back", "camera_orbit_deg": [0, 67], "camera_distance_scale": 1},
    "technical_iso": {"camera_view": "front", "camera_orbit_deg": [35, 24], "camera_distance_scale": 1},
    "left_side_zoomed": {"camera_view": "left", "camera_distance_scale": 0.8},
    "right_side_zoomed": {"camera_view": "right", "camera_distance_scale": 0.8},
}
STYLE_PRESETS: dict[str, dict[str, object]] = {
    DEFAULT_STYLE_PRESET_NAME: {
        "line_alpha": 255,
        "line_width_px": 5,
        "line_outline_color": ANNOTATION_COLOR_WHITE,
        "line_outline_alpha": 190,
        "angle_radius_outline_alpha": 180,
        "line_outline_width_px": 10,
        "extension_outline_width_px": 10,
        "radial_line_outline_width_px": 10,
        "arc_line_outline_width_px": 10,
        "angle_radius_arc_outline_width_px": 10,
        "extension_width_px": 2,
        "extension_visible": True,
        "extension_dash_px": 8,
        "extension_gap_px": 6,
        "tick_length_px": 14,
        "radial_line_width_px": 2.5,
        "radial_dash_px": 20,
        "radial_gap_px": 12.8,
        "label_font_size_px": ANNOTATION_LABEL_FONT_SIZE_PX,
        "label_color": ANNOTATION_COLOR_BLACK,
        "label_color_by_segment": True,
        "label_outline_color": ANNOTATION_COLOR_WHITE,
        "label_outline_width_px": 5,
        "angle_fill_color": ANNOTATION_COLOR_RED,
        "angle_fill_alpha": 30,
        "label_avoidance_padding_px": 4,
        "show_values": False,
        "auto_adjust_labels": False,
        "image_label_margin_px": 32,
        "image_label_title_area": True,
        "image_label_title_positions": ["bottom"],
        "image_label_title_padding_x_px": 22,
        "image_label_title_padding_y_px": 10,
        "image_label_title_radius_px": 18,
        "image_label_title_fill_color": ANNOTATION_COLOR_WHITE,
        "image_label_title_fill_alpha": 224,
        "image_label_title_outline_color": ANNOTATION_COLOR_BLACK,
        "image_label_title_outline_alpha": 255,
        "image_label_title_outline_width_px": 5,
        "image_label_title_min_width_px": 120,
        "image_label_title_top_margin_px": 8,
        "image_label_title_bottom_margin_px": 8,
        "type_styles": DEFAULT_TYPE_STYLES,
    }
}
BUILTIN_CONFIG_CONSTANTS: dict[str, object] = {
    "annotation_label_font_size_px": ANNOTATION_LABEL_FONT_SIZE_PX,
    "annotation_title_font_size_px": ANNOTATION_TITLE_FONT_SIZE_PX,
    "annotation_aux_label_font_size_px": ANNOTATION_AUX_LABEL_FONT_SIZE_PX,
    "annotation_font": ANNOTATION_FONT,
    "annotation_color_black": ANNOTATION_COLOR_BLACK,
    "annotation_color_blue": ANNOTATION_COLOR_BLUE,
    "annotation_color_red": ANNOTATION_COLOR_RED,
    "annotation_color_white": ANNOTATION_COLOR_WHITE,
    "default_annotation_style": {"preset": DEFAULT_STYLE_PRESET_NAME},
}
